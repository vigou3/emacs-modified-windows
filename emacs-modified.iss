...
AppName=GNU Emacs
AppVerName=GNU Emacs 27.2-modified-1
AppId=GNUEmacs-27.2-modified-1
...
DefaultDirName={pf}\GNU Emacs 27.2
DefaultGroupName=GNU Emacs 27.2
LicenseFile=emacs\share\emacs\27.2\etc\COPYING
OutputDir=..
OutputBaseFilename=emacs-27.2-modified-1
...
[Run]
Filename: "{app}\share\emacs\27.2\README-Modified.txt"; Description: "{cm:ReadMe}"; Flags: postinstall shellexec skipifsilent
...
Source: "README-Modified.txt"; DestDir: "{app}\share\emacs\27.2"; Flags: ignoreversion
Source: "NEWS"; DestDir: "{app}\share\emacs\27.2"; Flags: ignoreversion
