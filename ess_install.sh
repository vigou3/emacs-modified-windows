## It seems some permissions are not right in the archive
chmod -R u+w *
...
-e '/^EMACS/s/emacs/c:\/docume~1\/vincent\/mesdoc~1\/emacsm~1\/trunk\/emacs-22.2\/bin\/emacs.exe/' \
-e '/^LISPDIR/s/share\/emacs\/site-lisp/lisp/' \
-e '/^INFODIR/d' \
-e '/^ETCDIR/{s/share\/emacs\/etc\/ess/etc/;G;s/$/DOCDIR=\$(PREFIX)\/doc/;G;s/$/INFODIR=\$(DOCDIR)\/info/;}' Makeconf.orig > Makeconf
