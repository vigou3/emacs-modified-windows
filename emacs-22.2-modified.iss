[Setup]
AppName=GNU Emacs
AppVerName=GNU Emacs 22.2-modified-3
...
LicenseFile=emacs-22.2\etc\COPYING
OutputDir=..
OutputBaseFilename=emacs-22.2-modified-3
...
[Files]
Source: "emacs-22.2\*"; DestDir: "{app}"; Excludes: ".svn"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "ess-5.3.7\*"; DestDir: "{app}\site-lisp\ess-5.3.7"; Excludes: ".svn"; Flags: ignoreversion recursesubdirs createallsubdirs
